...
describe('Testing normal forms for numerical expressions', () => {
  ...
  const t = [
    ...
    ['sqrt(25)', '5'],
    ['sqrt(32)', '4*2^(1/2)'],
    ['sqrt(20)+sqrt(45)', '5*5^(1/2)'],
    ['sqrt(20)+sqrt(45)+sqrt(98)', '7*2^(1/2)+5*5^(1/2)'],
    ['sqrt(2^2)', '2'],
    ['sqrt(2)^3', '2*2^(1/2)'],
    ['sqrt(2)^8', '16'],
    ['sqrt(2)^(-8)', '1/16'],
    ['sqrt(2)+sqrt(2)', '2*2^(1/2)'],
    ['3+sqrt(2)+sqrt(2)', '3+2*2^(1/2)'],
    ['cos(3)+cos(3)', '2*cos(3)'],
    ['cos(3)+cos(4)', 'cos(3)+cos(4)'],
    ['(2+3*sqrt(2))(4+5*sqrt(2))', '38+22*2^(1/2)'],
    ['(2-3*sqrt(2))(-4+5*sqrt(2))', '-38+22*2^(1/2)'],
...
describe('Testing normal forms for litteral expressions', () => {
  ...
  const t = [
    ...
    ['(4x-6y)/(-10x+14y)', '(2*x-3*y)/(-5*x+7*y)'],
    ['sqrt(2)x+sqrt(2)x', '2*2^(1/2)*x'],
    ['cos(3)x+cos(3)x', '2*cos(3)*x'],
    ['cos(3)x+cos(4)x', '(cos(3)+cos(4))*x'],
    ['3x+sqrt(2)x', '(3+2^(1/2))*x'],
    ['3x+sqrt(2)x+sqrt(2)x', '(3+2*2^(1/2))*x'],
    ['5+x+3x+sqrt(2)x+cos(4)x', '5+(4+2^(1/2)+cos(4))*x'],
    ['x+3x+sqrt(2)*x+4*sqrt(2)*x+cos(4)*x+5*cos(4)*x', '(4+5*2^(1/2)+6*cos(4))*x'],
    ['(2+3*sqrt(x))(4+5*sqrt(x))', '8+22*x^(1/2)+15*x'],
    ['(2+3*sqrt(x))(4+5*sqrt(x))+x', '8+22*x^(1/2)+16*x'],
    ['(2-3*sqrt(x))(-4+5*sqrt(x))', '-8+22*x^(1/2)-15*x'],
