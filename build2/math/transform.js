...
function removeNullTerms(node) {
  ...
  if (node.isSum()) {
    ...
    if (first.equals((0, _node.zero)()) && last.equals((0, _node.zero)())) {
      e = (0, _node.number)(0);
    } else if (first.equals((0, _node.zero)())) {
      e = (0, _math.math)(last.string);
    } else if (last.equals((0, _node.zero)())) {
    ...
    if (_first.equals((0, _node.zero)()) && _last.equals((0, _node.zero)())) {
      e = (0, _node.number)(0);
    } else if (_first.equals((0, _node.zero)())) {
      e = (0, _math.math)(_last.string).oppose();
    } else if (_last.equals((0, _node.zero)())) {
